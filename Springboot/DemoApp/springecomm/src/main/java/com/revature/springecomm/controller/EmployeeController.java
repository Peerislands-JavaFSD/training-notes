...
@Tag(name = "Employee", description = "EMployee management ops")
public class EmployeeController {
    ...
    @Operation(summary = "Create Employee", description = "Create an employee")
    @ApiResponses({
    ...
    @Operation(summary = "GEt all Employee", description = "Create an employee")
    @ApiResponses({
    ...
    public ResponseEntity<Map<String, String>> sendNullError(Exception ex){
